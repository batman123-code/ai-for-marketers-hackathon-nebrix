  ...
  return (
    <div className="flex-1 space-y-6 max-w-4xl">
      <div className="flex flex-col gap-4 rounded-[32px] border border-border bg-card p-6">
        ...
        <p className="text-sm leading-6 text-muted-foreground">Manage your company credentials and personal configurations.</p>
      </div>
          ...
          <form onSubmit={handleProfileSubmit}>
            <Card className="bg-card/50 backdrop-blur-xl border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <Button type="submit" disabled={saveProfileMutation.isPending} className="rounded-full">
          ...
          <form onSubmit={handleCompanySubmit}>
            <Card className="bg-card/50 backdrop-blur-xl border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <Button type="submit" disabled={saveCompanyMutation.isPending} className="rounded-full">
